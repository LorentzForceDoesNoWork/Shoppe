...
import com.dhu.user.constants.UserConstants;
import com.dhu.user.mapper.UserMapper;
import com.dhu.user.service.UserService;
import com.dhu.utils.MD5Util;
...
public class UserServiceImpl implements UserService {
    ...
    public Object update(User user) {
        ...
        if (total == 0){
           //密码不同,已经修改! 新密码需要加密
           user.setPassword(MD5Util.encode(user.getPassword()+ com.dhu.constants.UserConstants.USER_SLAT));
        }
